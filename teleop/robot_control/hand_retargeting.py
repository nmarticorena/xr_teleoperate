...
class HandRetargeting:
    def __init__(self, hand_type: HandType):
        ...
        try:
            ...
            self.left_indices = (
                self.left_retargeting.optimizer.target_link_human_indices
            )
            self.right_indices = (
                self.right_retargeting.optimizer.target_link_human_indices
            )

            if (
                hand_type == HandType.UNITREE_DEX3
                or hand_type == HandType.UNITREE_DEX3_Unit_Test
            ):
                ...
                hand_type == HandType.INSPIRE_HAND
                or hand_type == HandType.INSPIRE_HAND_Unit_Test
            ):
                ...
                hand_type == HandType.BRAINCO_HAND
                or hand_type == HandType.BRAINCO_HAND_Unit_Test
            ):
